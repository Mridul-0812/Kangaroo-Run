...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    stroke(3);
    fill("black");
    text("Beautifully played! Better luck next time! ", 70,200);
      gameState = END;
    }
...
function spawnObstacles() {
  if(frameCount % 120 === 0) {
    ...
    obstacle.velocityX = -(score*1.5 + 2.5)
    obstacle.scale = 0.15;      
